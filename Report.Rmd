...
the GDP per Capital data for diffrent contries is stored using the .csv with this little piece of code -
...
To represent different countries that take part in the ODI world cup each, we used the following code to mark their coordinates and display them in the world map -
