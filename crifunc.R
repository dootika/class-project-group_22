...
###################################################################
# 
# country_player_name$India
# country_player_name$Pakistan
# 
# country$India
# country$Pakistan
# 
# Team_Data_1 <-country$India 
# Team_Data_2 <-country$Pakistan
# Team_name_1 <-Country$India
# Team_name_2 <-Country$Pakistan
...
# 
# for(Ind in 1:11){
#   x <- sample(c(0,1,2,3,4,6),1,replace = TRUE,prob = c(Team_Data_1[[Ind]]$Batting[[1]]))
#   print(x)
# }
